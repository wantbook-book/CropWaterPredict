...
def main_train():
    ...
    patience = 20
    num_epochs = 1
    # print('='*10+'soil_moisture_predict: segment rgb_vgg16_train'+'='*10)
    ...
    #     results_dir=Path('train/soil_moisture_predict/segment_rgb_vgg16')
    # )
    ...
    # print('='*10+'soil_moisture_predict: segment rgb_vgg16_tm_train'+'='*10)
    # smp_train.rgb_vgg16_tm_trian(
    #     rgb_images_dir=segment_images_dir, 
    #     temp_moisture_filepath=temp_moisture_file_path,
    #     soil_moisture_filepath=soil_moisture_file_path,
    ...
    #     num_workers=16,
    #     save_models=save_models,
    #     results_dir=Path('train/soil_moisture_predict/segment_rgb_vgg16_tm')
    # )
    ...
    # print('='*10+'sapflow_predict: rgb_renet18_tm_transformer_train'+'='*10)
    ...
    # print('='*10+'sapflow_predict: tm_mlp_train'+'='*10)
    # sfp_train.tm_train(
    #     rgb_images_dir=sapflow_rgb_images_dir, 
    #     sapflow_dir=sapflow_dir,
    #     temp_moisture_filepath=temp_moisture_file_path,
